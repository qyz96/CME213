...
/*             for(int i = 0; i < nn.W.size(); ++i) {
            ...
            MPI_SAFE_CALL(MPI_Allreduce(MPI_IN_PLACE, bpgrads.dW[0].memptr(), bpgrads.dW[0].n_elem, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD));
            MPI_SAFE_CALL(MPI_Allreduce(MPI_IN_PLACE, bpgrads.dW[1].memptr(), bpgrads.dW[1].n_elem, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD));
            MPI_SAFE_CALL(MPI_Allreduce(MPI_IN_PLACE, bpgrads.db[0].memptr(), bpgrads.db[0].n_elem, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD));
            MPI_SAFE_CALL(MPI_Allreduce(MPI_IN_PLACE, bpgrads.db[1].memptr(), bpgrads.db[1].n_elem, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD));
