...
double device_graph_iterate(
    ...
    {
         cudaMemcpy(device_input_array, h_node_values_input, 2*num_nodes, cudaMemcpyHostToDevice);
         cudaMemcpy(device_invs, h_inv_edges_per_node, 2*num_nodes, cudaMemcpyHostToDevice);
