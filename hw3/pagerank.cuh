...
double device_graph_iterate(
    ...
    {
         checkCudaErrors(cudaMemcpy(device_input_array, h_node_values_input, num_nodes, cudaMemcpyHostToDevice));
         checkCudaErrors(cudaMemcpy(device_invs, h_inv_edges_per_node, num_nodes, cudaMemcpyHostToDevice));
